...
export interface Project {
    ...
    client: string;
    location: string;
    category: 'Χωρίσματα' | 'Πόρτες' | 'Καθρέφτες' | 'Εξωτερικά' | 'Κάγκελα' | 'Ειδικές';
    clientCategory: 'Ξενοδοχεία' | 'Κατοικίες' | 'Επαγγελματικοί χώροι' | 'Εστίαση' | 'Άλλο';
    year: string;
    coverImage: string;
...
export const projectsData: Project[] = [
    ...
    },
    {
        ...
        category: 'Χωρίσματα',
        clientCategory: 'Επαγγελματικοί χώροι',
        year: '2024',
